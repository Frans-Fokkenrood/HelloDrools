...
import com.fokkenrood.antlr.DomoticaSpraakParser.InvoerContext;
import com.fokkenrood.antlr.DomoticaSpraakParser.ObjectContext;
import com.fokkenrood.antlr.DomoticaSpraakParser.RegelContext;
import com.fokkenrood.antlr.DomoticaSpraakParser.StatementsContext;
import com.fokkenrood.antlr.DomoticaSpraakParser.TestcaseContext;
import com.fokkenrood.antlr.DomoticaSpraakParser.TestgevalContext;
import com.fokkenrood.antlr.DomoticaSpraakParser.ToekennenContext;
import com.fokkenrood.antlr.DomoticaSpraakParser.VoorwaardeContext;
import com.fokkenrood.service.VertaalTabelLezer;


public class DomoticaDroolsListener extends DomoticaSpraakBaseListener {
...
//	private Stack<String>					stackAndOr		= new Stack<String>();
	...
	public void enterStatements(StatementsContext ctx) {
		System.out.println("Start vertaling DomoticaSpraak naar Drools DRL:");
		System.out.println("-----------------------------------------------");	
	...
	public void enterRegel(RegelContext ctx) {
		...
		drlWhen.append("\n\n");
		drlWhen.append("import com.fokkenrood.drools.Automaat;\n");
		drlWhen.append("\n");
		drlWhen.append("rule \"");
	...
	public void exitVoorwaarde(VoorwaardeContext ctx) {
		...
		if (ctx.f1 != null) {
			drlWhen.append("      ");
			drlWhen.append(vertaler.zoekFeit("FEITEN", ctx.f1.signifier));
			drlWhen.append(" ");
		...
		if (ctx.f2 != null) {
			drlWhen.append("      ");
			drlWhen.append(vertaler.zoekFeit("FEITEN", ctx.f2.signifier));
	...
	public void enterTestcase(TestcaseContext ctx) {
		...
		javaCase.append("<[[Automaat]]>import com.fokkenrood.drools.Automaat;\n");
		javaCase.append("\n");
